...
// See alos https://docs.qmk.fm/#/keycodes
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        GRV,     1,     2,     3,    F4,    F5,                     F6,    F7,    F8,    F9,   F10,  BSPC,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      CTLTB,     4,     5,     6,    F1,    F2,                  LEFT,   DOWN,    UP, RIGHT,  RBRC,  BSLS,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LSFT,     7,     8,     9,     0,    F5,                    F11,   F12,    F8,   DOT,   F10, ALTKN,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      TAB, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,                     MINS,   EQL,   GRV,  LBRC,  RBRC,  PIPE,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LSFT, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,                   UNDS,  PLUS,  TILD,  LCBR,  RCBR,  BSLS,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
